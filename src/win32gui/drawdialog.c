...
//Added by Roozbeh
  case IDC_JOINT:
    DialogBox (hInstance, MAKEINTRESOURCE (IDD_JOINT), hDlg, JointDlgProc);
    break;

  case IDC_TUNNEL:
    DialogBox (hInstance, MAKEINTRESOURCE (IDD_TUNNEL), hDlg, TunnelDlgProc);
    break;

  case IDC_ARC:
    DialogBox (hInstance, MAKEINTRESOURCE (IDD_ARC), hDlg, ArcDlgProc);
    break;

  case IDC_BLOCK:
    DialogBox (hInstance, MAKEINTRESOURCE (IDD_BLOCK), hDlg, BlockDlgProc);
    break;
//Added by Roozbeh
